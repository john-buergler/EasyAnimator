...
/**
 * The View for an animation. Could be rendered as text, SVG, or as a JFrame graphical animation.
...
public interface IView {
  ...
  /**
   * The method that renders the animation as per the specifications above.
   */
